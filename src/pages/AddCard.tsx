...
export default function AddCard() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // 2. Prepare Custom Attributes JSON
            ...
            const { error: insertError } = await supabase
                ...
                .insert([{
                    ...
                    // Legacy/Fallback for display if schema requires name
                        ...
                        <div className="grid grid-cols-2 gap-4 sm:grid-cols-3 md:grid-cols-4">
                            {previewUrls.map((url, idx) => (
                                <div key={idx} className="relative aspect-[3/4] group">
                                    <img src={url} alt={`Preview ${idx}`} className="h-full w-full rounded-lg object-cover border border-border" />
                                    <button
                                        type="button"
